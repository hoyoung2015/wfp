...
public class CopyOfCompanySocialReportDetailSprderPageProcessor implements PageProcessor {
...
//				String data2 = getData(title2);
				...
				for (Selectable li : lis) {
					...
					dbo.append(details[0], details[1]);
				}
			}
		}
	...
	public static void main(String[] args) throws JMException {
		...
		Spider spider = Spider
				.create(new CopyOfCompanySocialReportDetailSprderPageProcessor())
